...
class EventType(StrEnum):
    ...
    STUDENT_HEAD_TURNING = "STUDENT_HEAD_TURNING"
...
class AppConfig(BaseModel):
    ...
    DEFAULT_RISK_SCORES: ClassVar[dict[EventType, int]] = {
        ...
        EventType.STUDENT_STANDING: 40,
        EventType.STUDENT_HEAD_TURNING: 50,
        EventType.PAPER_EXCHANGE: 80,
        EventType.STUDENT_GROUPING: 60,
        EventType.CROWD_MOVEMENT: 60,
